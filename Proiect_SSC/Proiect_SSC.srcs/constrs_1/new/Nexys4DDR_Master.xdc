...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { Read_out }]; #IO_L18P_T2_A24_15 Sch=led[0]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { Rst_out }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { sign }]; #IO_L19N_T3_A21_VREF_15 Sch=dp
...
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { Read }]; #IO_L4N_T0_D05_14 Sch=btnu
...
set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { SS[0] }]; #IO_L12P_T1_MRCC_15 Sch=acl_csn
